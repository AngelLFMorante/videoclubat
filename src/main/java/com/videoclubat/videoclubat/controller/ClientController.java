...
public class ClientController {
    ...
    private ResponseEntity<Object> addNewClient(@Valid @RequestBody Client dataClient){
    ...
    private ResponseEntity<Object> editClient(@Valid @PathVariable Long id, @RequestBody Client editClient){
    ...
    private ResponseEntity<Object> deleteClient(@PathVariable Long id){
